editOptions() {
    ...
    local LAST_SELECTED_OPTION  # <-- added
    ...
    while true; do
        ...
        if [ -z "$SELECTED_OPTION" ]; then
            ...
            case "$?" in
                ...
                2)
                    TASK="MANAGE_PATCHES"
                    unset OPTIONS_JSON SELECTED_OPTION LAST_SELECTED_OPTION NEW_VALUE
                    return 1
                    ;;
            esac
        else
            ...
            LAST_SELECTED_OPTION="$SELECTED_OPTION"  # <-- save before unsetting
