...
fetchAssetsInfo() {
    ...
    if [ "$remaining" -gt 3 ]; then
        ...
        if [ "$SOURCE" == "LisoUseInAIKyrios" ]; then
            CLI_API_URL="https://api.github.com/repos/inotia00/revanced-cli-patcher-22/releases"
        elif [ "$SOURCE" == "MorpheApp" ]; then
