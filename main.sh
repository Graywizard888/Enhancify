...
main() {
    ...
    THANKS_MSG+="  ⭐ Thank you for 50 stars on GitHub! ⭐\n"
    THANKS_MSG+="  Your support keeps this project alive!\n"
    THANKS_MSG+="  Thank you to those who supported this project so far\n"
    THANKS_MSG+="\n"
    THANKS_MSG+="Initiated Mode : $PRIVILEGE_STATUS\n"
    THANKS_MSG+="Status : $ONLINE_STATUS\n"
    THANKS_MSG+="Arch : $ARCH\n"
    THANKS_MSG+="\n$NAVIGATION_HINT"
